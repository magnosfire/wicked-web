...
;(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        buildDayDropdown: function () {
            var day,
                dropdown = this.buildBaseDropdown('day day-dropdown'),
        ...
        buildMonthDropdown: function () {
            // MonthDropdown class
            var dropdown = this.buildBaseDropdown('month month-dropdown'),
                option = document.createElement('option');
        ...
        buildYearDropdown: function () {
            var minYear = this.config.minYear,
                ...
                dropdown = this.buildBaseDropdown('year year-dropdown'),
                option = document.createElement('option');
